...
(function (factory) {
    ...
    var INewMessage = /** @class */ (function () {
        function INewMessage() {
        }
        return INewMessage;
    }());
    exports.INewMessage = INewMessage;
    var MsgView = /** @class */ (function (_super) {
        __extends(MsgView, _super);
        function MsgView(observalizer, loginService, _emailService) {
        ...
        MsgView.prototype.initialize = function (conversation) {
        ...
        MsgView.prototype.send = function () {
            ...
            this._connected.then(function (user) {
                if (_this.observable.content) {
                    ...
                    msg.conversation = _this._conversation;
                    msg.message = _this.observable.content;
                    msg.writtenBy.id = user.id;
                    _this._emailService.send(msg)
                        .then(function () { return _this.observable.content = ""; });
                }
            });
        };
        MsgView = __decorate([
            artiste_1.View({
                template: "tmpl/email/read/conversation/new-message.html",
                binding: {
