...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "artiste", "service/login"], factory);
    }
    ...
    var MessageView = /** @class */ (function (_super) {
        ...
        MessageView = __decorate([
            artiste_1.View({
                template: "tmpl/email/inbox/conversation/message.html",
                binding: {
                    "[data-id=content]": function (msgview) { return [
                        artiste_1.text(function () { return msgview.observable.content; }),
