...
(function (factory) {
    ...
    var IndexView = /** @class */ (function (_super) {
        ...
        function IndexView(observalizer, viewProvider, notifier, _emailService) {
            ...
            notifier.forEvent(index_2.IIndex.MOVE).listen(_this.observable.selection, function (data) {
                data.callback(_this.observable.conversation).then(function () {
                    _this.observable.conversation.add(data.id);
                });
            });
            return _this;
        }
        IndexView = __decorate([
            artiste_1.View({
                template: "tmpl/email/create/index.html",
                binding: {
