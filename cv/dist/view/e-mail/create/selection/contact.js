...
(function (factory) {
    ...
    var IContact = /** @class */ (function () {
        ...
        IContact.MOVE = new artiste_1.Event("MOVE");
        return IContact;
    }());
    ...
    var ContactView = /** @class */ (function (_super) {
        ...
        ContactView.prototype.move = function (callback) {
            this._notifier.forEvent(IContact.MOVE).notify(this, { callback: callback, id: this.observable.id });
        };
        ContactView = __decorate([
            artiste_1.View({
                template: "tmpl/email/create/selection/contact.html",
                binding: {
                    "this": function (contactView) { return [
                        move_1.move(function (callback) { return contactView.move(callback); })
                    ]; },
