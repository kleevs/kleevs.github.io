...
(function (factory) {
    ...
    var IBlog = /** @class */ (function (_super) {
        __extends(IBlog, _super);
        function IBlog() {
    ...
    var Blog = /** @class */ (function (_super) {
        ...
        function Blog(_resourceText, _porteFolioService, _viewProvider, observalizer, notifier) {
            return _super.call(this, _resourceText, _porteFolioService, _viewProvider, observalizer, notifier) || this;
        }
        Blog = __decorate([
            artiste_1.View({
                template: "tmpl/layout/blog.html"
            }),
