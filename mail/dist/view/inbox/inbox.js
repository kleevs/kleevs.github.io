...
(function (factory) {
    ...
    var IInbox = /** @class */ (function () {
        ...
        IInbox.Event = {
            Read: new artiste_1.Event("inbox:inbox:read")
        };
        return IInbox;
    }());
    ...
    var Inbox = /** @class */ (function (_super) {
        ...
        function Inbox(observablizer, viewProvider, messageService, notifier) {
        ...
        Inbox.prototype.setLogin = function (login) {
            ...
            this.messageService.inbox(login).then(function (messages) {
                _this.observable.messages = messages;
            });
        };
        Inbox.prototype.read = function (message) {
            var view = this.viewProvider.newInstance(read_1.IRead);
            view.setLogin(this.observable.login, message);
            this.notifier.forEvent(IInbox.Event.Read).notify(this, view);
            return true;
        };
        Inbox = __decorate([
            artiste_1.View({
                template: "tmpl/inbox/inbox.html",
                binding: {
                    "table tbody": function (inboxView) { return artiste_1.each(function () {
                        return inboxView.observable.messages.slice(inboxView.observable.currentPage * inboxView.observable.pageLength, (inboxView.observable.currentPage + 1) * inboxView.observable.pageLength).map(function (message) {
                            return {
                                "this": [
                                    artiste_1.click(function () { return function (e) { return inboxView.read(message); }; }),
                                    artiste_1.classes(function () {
                                        return { unread: !message.isOpen };
                                    })
                                ],
                    ...
                    "[data-id=page]": function (inboxView) { return [
                        ...
                        artiste_1.value({
                            get: function () { return "" + (inboxView.observable.currentPage || 0); },
                            set: function (v) { return inboxView.observable.currentPage = parseInt(v); }
                        })
                    ]; },
                    "[data-id=page-length]": function (inboxView) { return artiste_1.value({
                        get: function () { return "" + (inboxView.observable.pageLength || 0); },
                        set: function (v) { return inboxView.observable.pageLength = parseInt(v); }
                    }); },
